...
@php
    $products = [
        [ 'name' => 'Propylene Glycol (PG)', 'description' => 'Digunakan sebagai humektan dan pelarut dalam berbagai produk kosmetik dan personal care.' ],
        [ 'name' => 'Citric Acid', 'description' => 'Agen pengatur pH dan pengawet alami dalam produk kosmetik.' ],
        [ 'name' => 'Glycerin', 'description' => 'Bahan pelembap alami yang menjaga kelembapan kulit.' ],
        [ 'name' => 'Hydrogen Peroxide', 'description' => 'Digunakan sebagai agen pencerah dan oksidator dalam kosmetik.' ],
        [ 'name' => 'Ammonia', 'description' => 'Bahan dasar dalam produk pewarna rambut dan pengatur pH.' ],
        [ 'name' => 'Poly Propylene Glycol', 'description' => 'Digunakan dalam formula personal care sebagai pelarut dan emolien.' ],
        [ 'name' => 'Soda Ash', 'description' => 'Pengatur alkalinitas dan bahan pembantu dalam formulasi kosmetik.' ],
        [ 'name' => 'Sulphuric Acid', 'description' => 'Digunakan secara industri dalam produksi bahan baku kosmetik.' ],
        [ 'name' => 'Phosphoric Acid', 'description' => 'Pengatur pH dan bahan tambahan dalam produk personal care.' ],
        [ 'name' => 'Stearic Acid', 'description' => 'Bahan dasar dalam pembuatan sabun dan kosmetik sebagai pengental alami.' ],
    ];
@endphp

<!-- SECTION INTRO -->
<section class="bg-[#0F2573] py-20 text-white" id="cosmetic-care-section">
    <div class="max-w-7xl mx-auto px-4 text-center animate-slideFadeZoomIn">
        ...
        <div class="mb-10 animate-slideFadeZoomIn" style="animation-delay: 0.1s">
            <img src="{{ asset('images/cosmetic-banner.jpg') }}" alt="Cosmetic Chemicals"
                class="mx-auto rounded-xl shadow-lg w-full max-w-4xl object-cover h-72 border-4 border-white">
        </div>
        ...
        <p class="text-white/80 max-w-3xl mx-auto text-base md:text-lg mb-10 leading-relaxed animate-slideFadeZoomIn" style="animation-delay: 0.3s">
            Produk kosmetik dan personal care diformulasikan dengan bahan kimia seperti emulgator, surfaktan, dan pengawet untuk menjaga stabilitas fisik, efektivitas, dan daya tahan produk.
        </p>
    </div>

    <!-- PRODUK LIST TEXT ONLY -->
...
<section id="all-products" class="bg-white py-16 text-[#0F2573]">
    ...
    <div id="product-wrapper" class="hidden">
        <div class="max-w-6xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8 px-4 text-sm text-gray-700 leading-relaxed">
            @php
                $products = [
                            'Acrylic Acid', 'Acetic Acid', 'Aluminium Hydroxide', 'Aluminium Oxide', 'Aluminium Stearate', 'Aluminium Sulphate',
