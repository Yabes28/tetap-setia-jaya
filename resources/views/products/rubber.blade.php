...
@php
    $products = [
        [ 'name' => 'Stearic Acid', 'description' => 'Digunakan dalam industri karet dan pengolahan emas sebagai agen pengemulsi dan pengental.' ],
        [ 'name' => 'Caustic Soda', 'description' => 'Bahan kimia serbaguna untuk pemurnian emas dan pengolahan karet.' ],
        [ 'name' => 'Sodium Metabisulphite', 'description' => 'Digunakan dalam pemurnian emas dan aplikasi industri lainnya.' ],
        [ 'name' => 'Nitric Acid', 'description' => 'Bahan penting dalam pemrosesan emas dan industri kimia.' ],
        [ 'name' => 'Sulphuric Acid', 'description' => 'Digunakan dalam industri pertambangan dan pemurnian logam.' ],
        [ 'name' => 'Sodium Hydrosulphite', 'description' => 'Reduktan kuat untuk pengolahan emas dan aplikasi tekstil.' ],
    ];
@endphp

<!-- SECTION INTRO -->
<section class="bg-[#0F2573] py-20 text-white" id="rubbergold-section">
    <div class="max-w-7xl mx-auto px-4 text-center animate-slideFadeZoomIn">
        <div class="mb-10 animate-slideFadeZoomIn" style="animation-delay: 0.1s">
            <img src="{{ asset('images/rubber-gold-banner.jpg') }}" alt="Rubber & Gold Chemicals" class="mx-auto rounded-xl shadow-lg w-full max-w-4xl object-cover h-72 border-4 border-white">
        </div>
        <h1 class="text-3xl md:text-4xl font-bold mb-4 animate-slideFadeZoomIn" style="animation-delay: 0.2s">
            Rubber & Gold Chemicals
        </h1>
        <p class="text-white/80 max-w-3xl mx-auto text-base md:text-lg mb-10 leading-relaxed animate-slideFadeZoomIn" style="animation-delay: 0.3s">
            Kami menyediakan bahan kimia khusus untuk industri pengolahan karet dan pertambangan emas, dengan kualitas tinggi dan sesuai standar industri berat.
        </p>
    </div>
