...
@php
    $products = [
        [ 'name' => 'Ammonium Sulphate', 'description' => 'Pupuk nitrogen berkualitas untuk pertanian optimal.' ],
        [ 'name' => 'Ammonium Chloride', 'description' => 'Bahan pupuk nitrogen yang efektif untuk kebutuhan pertanian.' ],
        [ 'name' => 'Nitric Acid', 'description' => 'Bahan baku penting dalam produksi pupuk cair berkualitas.' ],
        [ 'name' => 'Urea', 'description' => 'Sumber nitrogen utama untuk meningkatkan hasil pertanian.' ],
        [ 'name' => 'TSP (Triple Super Phosphate)', 'description' => 'Pupuk fosfat berkualitas tinggi untuk pertumbuhan tanaman optimal.' ],
        [ 'name' => 'NPK', 'description' => 'Pupuk lengkap dengan kandungan Nitrogen, Fosfor, dan Kalium.' ],
        [ 'name' => 'Trisodium Phosphate', 'description' => 'Bahan tambahan pupuk untuk meningkatkan efisiensi nutrisi.' ],
        [ 'name' => 'Ferrous Sulphate', 'description' => 'Sumber zat besi untuk kesehatan tanaman dan hasil pertanian.' ],
        [ 'name' => 'Caustic Soda Flake', 'description' => 'Bahan kimia pendukung dalam industri pupuk dan pengolahan.' ],
    ];
@endphp

<!-- SECTION INTRO -->
<section class="bg-[#0F2573] py-20 text-white" id="fertilizer-section">
    <div class="max-w-7xl mx-auto px-4 text-center animate-slideFadeZoomIn">
        <div class="mb-10 animate-slideFadeZoomIn" style="animation-delay: 0.1s">
            <img src="{{ asset('images/fertilizer-banner.jpg') }}" alt="Fertilizer Chemicals" class="mx-auto rounded-xl shadow-lg w-full max-w-4xl object-cover h-72 border-4 border-white">
        </div>
        ...
        <p class="text-white/80 max-w-3xl mx-auto text-base md:text-lg mb-10 leading-relaxed animate-slideFadeZoomIn" style="animation-delay: 0.3s">
            Kami menyediakan bahan kimia khusus untuk industri pupuk, seperti nitrogen, fosfat, dan kalium, guna mendukung pertumbuhan tanaman dan produktivitas pertanian. Bahan-bahan ini teruji kualitasnya dan sesuai dengan standar industri pertanian.
        </p>
    </div>
